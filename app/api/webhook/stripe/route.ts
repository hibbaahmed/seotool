...
async function onSubCancel(subscription_id: string, req: any) {
	...
	try {
		...
		console.log('📤 Sending Unsubscribe event to Facebook:', JSON.stringify(facebookEventData, null, 2));
		...
		if (facebookResult.error) {
			...
			console.log('✅ Facebook Conversions API Unsubscribe event sent successfully:', facebookResult);
		}
