      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 lg:px-8">
        ...
        <div className="hidden lg:flex items-center space-x-2">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <div className="flex items-center group">
                <Link href="/templates" className="flex items-center px-5 py-2.5 text-slate-700 hover:text-slate-900 rounded-xl transition-all duration-300 font-medium border border-transparent hover:border-purple-100 hover:shadow-sm hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50">
                  Templates
                </Link>
                <button className="ml-1 text-slate-600 hover:text-slate-900 focus:outline-none group-hover:text-purple-600 transition-colors duration-200">
                  <ChevronDown size={16} className="transition-transform duration-200 group-hover:rotate-180" />
            ...
            <DropdownMenuContent className="absolute left-0 mt-2 w-[650px] rounded-2xl shadow-2xl bg-white/95 backdrop-blur-xl ring-1 ring-purple-100/50 transition-all duration-300 z-50 border border-gradient-to-r from-purple-100 to-blue-100">
              <div className="grid grid-cols-2 gap-8 p-8">
                <div>
                  ...
                  <ul className="space-y-3">
                    <li>
                      <Link href="/templates/dashboard" className="text-slate-600 hover:text-slate-900 hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50 px-3 py-2 rounded-lg transition-all duration-200 flex items-center group">
                        <Monitor className="w-4 h-4 mr-2 text-purple-500 group-hover:text-purple-600" />
                        Dashboard Apps
                      </Link>
                    </li>
                    <li>
                      <Link href="/templates/ecommerce" className="text-slate-600 hover:text-slate-900 hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50 px-3 py-2 rounded-lg transition-all duration-200 flex items-center group">
                        <DollarSign className="w-4 h-4 mr-2 text-blue-500 group-hover:text-blue-600" />
                        E-commerce Sites
                      </Link>
                    </li>
                    <li>
                      <Link href="/templates/portfolio" className="text-slate-600 hover:text-slate-900 hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50 px-3 py-2 rounded-lg transition-all duration-200 flex items-center group">
                        <Eye className="w-4 h-4 mr-2 text-indigo-500 group-hover:text-indigo-600" />
                        Portfolio Sites
                      </Link>
                    </li>
                    <li>
                      <Link href="/templates/blog" className="text-slate-600 hover:text-slate-900 hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50 px-3 py-2 rounded-lg transition-all duration-200 flex items-center group">
                        <FileText className="w-4 h-4 mr-2 text-purple-500 group-hover:text-purple-600" />
                        Blog Platforms
                      </Link>
                    </li>
                  </ul>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    <li>
                      <Link href="/templates/saas" className="text-slate-600 hover:text-slate-900 hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50 px-3 py-2 rounded-lg transition-all duration-200 flex items-center group">
                        <Zap className="w-4 h-4 mr-2 text-purple-500 group-hover:text-purple-600" />
                        SaaS Applications
                      </Link>
                    </li>
                    <li>
                      <Link href="/templates/landing" className="text-slate-600 hover:text-slate-900 hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50 px-3 py-2 rounded-lg transition-all duration-200 flex items-center group">
                        <Home className="w-4 h-4 mr-2 text-blue-500 group-hover:text-blue-600" />
                        Landing Pages
                      </Link>
                    </li>
                    <li>
                      <Link href="/templates/mobile" className="text-slate-600 hover:text-slate-900 hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50 px-3 py-2 rounded-lg transition-all duration-200 flex items-center group">
                        <Monitor className="w-4 h-4 mr-2 text-indigo-500 group-hover:text-indigo-600" />
                        Mobile Apps
                      </Link>
                    </li>
                    <li>
                      <Link href="/templates/web3" className="text-slate-600 hover:text-slate-900 hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50 px-3 py-2 rounded-lg transition-all duration-200 flex items-center group">
                        <Github className="w-4 h-4 mr-2 text-purple-500 group-hover:text-purple-600" />
                        Web3 Apps
                      </Link>
                    </li>
                  </ul>
